module.exports = {
	up: async (queryInterface) => {
		...
		// 	// =============== 1. ส่วนนำ ===============
		// 	// {
		// 	// 	id: "e12263e9-cd10-4bd8-b040-ff550a0d1ba1",
		// 	// 	result: true,
		// 	// 	remark: "",
		// 	// 	file: null,
		...
		// ]
		// await queryInterface.bulkInsert('result_cfoeq_section', seedData)
	},

	down: async (queryInterface) => {
		await queryInterface.bulkDelete('result_cfoeq_section', {});
	}
}